...
android {
    ...
    defaultConfig {
        applicationId = "com.expectional.mtn2"
        resValue("string", "app_name", "MTN2")
        buildConfigField("String", "APP_NAME", "\"MTN2\"")
    ...
    sourceSets {
        getByName("main") {
            // Must match the SDL version bundled in rust-sdl2 (libSDL2.so), NOT vendor/SDL.
            java.srcDir("${rootDir}/sdl-java")
        }
    }
